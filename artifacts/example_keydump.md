...
SIEM in the same window: **0 process_create, 0 Defender events, no beacon.** In-process in w3wp. Only artifact = the /_trust POST + anomalous response. → rotate machine keys to revoke.
